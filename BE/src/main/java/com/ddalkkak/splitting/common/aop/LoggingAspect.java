//package com.ddalkkak.splitting.common.aop;
//
...
//     * @param joinPoint
//     */
//    @Before("execution(* com.ddalkkak.splitting.board.api.*.*(..))")
...
//     * @param joinPoint
//     */
//    @After("execution(* com.ddalkkak.splitting.board.api.*.*(..))")
...
//     * @param result
//     */
//    @AfterReturning(pointcut = "execution(* com.ddalkkak.splitting.board.api.*.*(..))", returning = "result")
...
//     * @param e
//     */
//    @AfterThrowing(pointcut = "execution(* com.ddalkkak.splitting.board.api.*.*(..))", throwing = "e")
...
//     * @throws Throwable
//     */
//    @Around("execution(* com.ddalkkak.splitting.board.api.*.*(..))")
